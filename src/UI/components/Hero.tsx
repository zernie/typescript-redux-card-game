...
type HeroProps = IHero & { isOver: boolean; weapon: IWeapon | null; mana: number; maximumMana: number }

const Hero: React.FC<HeroProps> = ({exhausted, isOver, name, cardID, armor, health, mana, maximumMana, weapon}) =>
   ( <div className="ui grid">
        <Grid.Column width={4}/>
        <Grid.Column width={2} verticalAlign="middle">
            {weapon && (
                <Weapon {...weapon} disabled={exhausted}/>
            )}
        </Grid.Column>
